<?php get_header();?>
                ...
                <div class="col-lg-8 order-1 order-lg-0 hero">
                    <div class="row">
                        ...
                        <div
                            ...
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/image2.png"
                                class="logo img-fluid">
                            <div class="content">
                                <h1>Get Admissions<br><span style="color:#99cc34;"> @Yenepoya</span></h1>
                                <p>
                                ...
                                <div class="buttons">
                                    <button class="btn btn1">
                                        View Our Products
                                        <img src="<?php bloginfo('template_directory'); ?>/assets/images/image1.png"
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="left-image1">
                                        ...
                                        <a href>
                                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/group1.png"
                                                alt
        ...
        <div class="container str">
            <div class="row s2">
                <div class="col-md-3 mb-4">
                    <div class="card text-center">
                        <div class="card-body  mt-3">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/image3.png">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card text-center">
                        <div class="card-body mt-3">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/image4.png">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card text-center">
                        <div class="card-body mt-3">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/image5.png">
                ...
                <div class="col-md-3 mb-4">
                    <div class="card text-center">
                        <div class="card-body mt-3">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/image6.png">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="left-image">
                            ...
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/image7.png" alt>
                            <a href="property-details.html"><img
                                    src="<?php bloginfo('template_directory'); ?>/assets/images/green.png" alt
        ...
        <div class="container my-container str">
            <div class="row">
                ...
                <div class="col-md-5 my-right-column">
                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/2.png" alt="My Image Description">
        ...
        . <!--SAFEEXPRESS -->
        <div class="container custom str bg">
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="left-image">
                            ...
                            <!-- Add the top-right square -->
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/image8.png" alt
                                class="about">
                            <a href="property-details.html"><img
                                    src="<?php bloginfo('template_directory'); ?>/assets/images/green.png" alt
                                    style="max-width: 60px; padding: 0px; height:auto; "></a>
                ...
                <div class="row">
                        ...
                        <div class="statistics-columns">
                            <div class="statistics-column col-md-6 col-sm-12">
                                <div class="statistics-item">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/7.png" alt="Icon 1">
                            ...
                            <div class="statistics-column col-md-6 col-sm-12">
                                <div class="statistics-item">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/3.png" alt="Icon 2">
                            ...
                            <div class="statistics-column col-md-6 col-sm-12">
                                <div class="statistics-item">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/8.png" alt="Icon 3">
                            ...
                            <div class="statistics-column col-md-6 col-sm-12">
                                <div class="statistics-item">
                                    <img src="<?php bloginfo('template_directory'); ?>/assets/images/5.png" alt="Icon 4">
                    ...
                    <div class="col-lg-5 col-sm-12 col-md-12video-column">
                        <div class="video-container">
                            <img src="<?php bloginfo('template_directory'); ?>/assets/images/image9.png"
                            ...
                            <p class="mt-3">Lorem ipsum dolor sit amet,
                                ...
                                <div class="d-flex align-items-center">
                                    <img class="custom-profile-icon"
                                        src="<?php bloginfo('template_directory'); ?>/assets/images/oval1.png"
                                        alt="Profile 1">
                                    <div>
                    ...
                    <div class="custom-card">
                        <div class="card-body">
                            ...
                            <p class="mt-3">Lorem ipsum dolor sit amet,
                                ...
                                <div class="d-flex align-items-center">
                                    <img class="custom-profile-icon"
                                        src="<?php bloginfo('template_directory'); ?>/assets/images/oval2.png"
                                        alt="Profile 2">
                                    <div>
                    ...
                    <div class="custom-card">
                        <div class="card-body">
                            ...
                            <p class="mt-3">Lorem ipsum dolor sit amet,
                                ...
                                <div class="d-flex align-items-center">
                                    <img class="custom-profile-icon"
                                        src="<?php bloginfo('template_directory'); ?>/assets/images/oval3.png"
                                        alt="Profile 3">
                                    <div>
